...
const SolutionCard: React.FC<{ solution: Solution }> = ({ solution }) => {
  ...
  return (
    ...
    >
      ...
      {/* Tag badge */}
      <span className="sg-card__tag">{solution.tag}</span>

      {/* Idle title bar */}
      <div className={`sg-card__footer${isHovered ? " sg-card__footer--hidden" : ""}`}>
        <div className="sg-card__footer-icon">{solution.icon}</div>
        <h3 className="sg-card__footer-title">{solution.title}</h3>
      </div>
      ...
      >
        <div className="sg-overlay__body">
          <div className="sg-overlay__icon">{solution.icon}</div>
          <div className="sg-overlay__sep" />
          <h3 className="sg-overlay__title">{solution.title}</h3>
          <p  className="sg-overlay__desc">{solution.description}</p>
  ...
  <section className="sg-section">
    <div className="sg-inner">
      <div className="section-header">
        ...
        <h2 className="section-title">Giải pháp & Dịch vụ</h2>
