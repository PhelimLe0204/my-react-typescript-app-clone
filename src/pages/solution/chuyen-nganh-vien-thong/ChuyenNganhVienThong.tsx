...
import "./ChuyenNganhVienThong.css";
...
const ChuyenNganhVienThong: React.FC = () => (
    <div className="about-content-section">
        <h2 className="about-content-title">Chuyên ngành viễn thông</h2>
...
export default ChuyenNganhVienThong;
